...
# --- Import Agent Logic ---
# Assumes this file (main.py) is in 'backend/app/'
try:
...
# *** CORRECTED PATH CALCULATION FOR DOCKER ***
# Inside the container, WORKDIR is /app, and frontend is copied to /app/frontend/
# So, the path relative to this script (in /app/app/) is ../frontend
